        ...
        {isMobile ? (
          <>
            <button
              ...
              className="fixed bottom-0 left-1/2 z-20 flex h-10 w-full max-w-xs -translate-x-1/2 items-center justify-center border-t border-gray-200 bg-white shadow-lg"
            ...
            {!sidebarCollapsed && (
              <>
                <div
                  ...
                  aria-label="关闭侧栏"
                />
                <aside className="fixed inset-x-0 bottom-10 top-12 z-40 overflow-hidden rounded-t-xl border-t border-gray-200 bg-white shadow-xl">
                  <Sidebar />
                </aside>
              </>
            )}
