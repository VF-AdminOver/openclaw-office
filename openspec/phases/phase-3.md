...
- [ ] GLTF 模型正确加载并替换了 BoxGeometry（延后：当前几何体表现良好）
- [x] Bloom 效果在连线和特效上生效
- [x] 日/夜模式切换平滑
- [x] 全息工具面板正确显示当前工具信息
- [x] Avatar 更丰富、更有辨识度
...
- [x] 点击 Agent 弹出上下文菜单
- [x] Send Message 弹窗可输入文本
- [x] Kill 操作有二次确认
- [x] 无权限时操作按钮被禁用
- [x] （如 Gateway 支持）操作可实际执行
...
- [x] Token 消耗折线图实时更新
- [x] 网络拓扑图正确展示 Agent 关系
- [x] 热力图展示 24 小时活跃度分布
- [x] 成本饼图准确反映各 Agent 占比
...
- [ ] 50 个 Agent 场景下 3D 帧率 ≥ 24fps（InstancedMesh 延后，当前 Agent 数量下无需优化）
- [x] 2D 模式不加载 Three.js（React.lazy + Suspense 代码分割已实现）
- [x] 小屏幕自动适配为 2D + 底部抽屉布局
- [ ] 所有文档更新完成（README 待完善）
- [x] 关键流程测试通过
